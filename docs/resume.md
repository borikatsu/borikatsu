...
サービス全体のドメイン知識を幅広く持つ注文の担当者が安全対策領域とコラボレーションすることで、より良い安全対策が行えるのではないか。
...
| 項目 | 内容 |
| ---------- | --- |
| 業務内容 | ・顧客企業向けスマートフォン/Web アプリケーション/サイネージプラットフォームのバックエンドシステムの設計・開発・保守 |
| 雇用形態 | 正社員 |
| チーム編成 | ・企画営業：1 - 2 名 <br>・エンジニア：1 名 <br>・オフショアメンバー 3 - 5 名 |
| 言語/FW | ・PHP v5 - v7(Laravel v5.2 - v8) <br> ・JavaScript(Vue.js v13, Node.js v16) |
| インフラ | ・CentOS6 - 7 <br> ・MySQL v5<br> |
| AWS | ・EC2 <br> ・ECS(Fargate) <br>・ECR <br> ・Lambda <br> ・SQS <br> ・SNS <br> ・SES <br><br>・RDS <br> ・DynamoDB <br> ・S3 <br> ・CloudFront <br> ・API Gateway <br> ・CloudWatch <br> ・CloudFormation <br><br> ・Glue <br> ・Athena <br> ・IoT Core <br> ・Elemental MediaConvert |
| 開発 | ・GitHub <br> ・git flow <br> ・Locust |
